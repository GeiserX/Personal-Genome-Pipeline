...
> **Only have 23andMe / MyHeritage / AncestryDNA?** You can still run pharmacogenomics, polygenic risk scores, ancestry, and ClinVar screening. See the **[chip data guide](docs/chip-data-guide.md)** for step-by-step conversion instructions and which pipeline steps work with ~600K SNP array data.
...
Yes, partially. You can convert chip data to VCF and run pharmacogenomics (step 7), PRS (step 25), ancestry (step 26), ClinVar screening (step 6), and ROH analysis (step 11). You cannot run alignment, variant calling, structural variants, or repeat expansions. See the **[chip data guide](docs/chip-data-guide.md)** for conversion instructions, which steps work, and what to expect.
